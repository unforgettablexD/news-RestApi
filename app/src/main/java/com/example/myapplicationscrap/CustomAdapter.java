...
public class CustomAdapter extends RecyclerView.Adapter<com.example.myapplicationscrap.CustomViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.myapplicationscrap.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new com.example.myapplicationscrap.CustomViewHolder(LayoutInflater.from(context).inflate(R.layout.headlines_list_container, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.myapplicationscrap.CustomViewHolder holder, int position) {
